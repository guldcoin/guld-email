(function () {
    ...
    function copyHtml() {
        var html =
            ...
            "                  <div class='col-sm-7'> " +
            "                    <input type='text' class='form-control' id='sender' placeholder='Sender' required> " +
            "                  </div> " +
            "                </div> " +
            "                <div class='form-group row'> " +
            "                  <label for='receiver' class='col-sm-5 col-form-label'>Receiver Guld Username</label> " +
            "                  <div class='col-sm-7'> " +
            "                    <input type='text' class='form-control' id='receiver' placeholder='Receiver' required> " +
            "                  </div> " +
            "                </div> " +
            "                <div class='form-group row'> " +
            "                  <label for='amount' class='col-sm-5 col-form-label'>Amount</label> " +
            "                  <div class='col-sm-7'> " +
            "                    <input type='number' step='.00000001' class='form-control' id='amount' placeholder='3.5' required> " +
            "                  </div> " +
            "                </div> " +
